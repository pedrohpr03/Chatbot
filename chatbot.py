...
print("=" * 50)
print("  🎵 Bem-vindo ao ChatBotMusic! 🎵")
print("  Pergunte sobre artistas, gêneros e músicas.")
print("  Digite 'sair', 'tchau' ou 'adeus' para sair.")
print("=" * 50)

while True:
    user_input = input("\nVocê: ")
    if user_input.lower() in ['sair', 'tchau', 'adeus', 'até mais', 'até logo']:
        print("ChatBotMusic: Até mais! Foi um prazer conversar com você. 🎵")
        break
