"""Chatbot de padrões (NLTK) — usado quando a mensagem não é um comando Spotify.

Conversa sobre gêneros e artistas com respostas pré-escritas.
"""
import random
...
_chatbot = Chat(pares, reflexoes)


def responder(message: str) -> str:
    """Resposta do chatbot de padrões. Sempre devolve um texto."""
    resposta = _chatbot.respond(message)
